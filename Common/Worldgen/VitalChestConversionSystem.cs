...
using ElementalHearts.Content.Items.Hearts.Vanilla.Common.Crafted;
using ElementalHearts.Content.Items.Hearts.Vanilla.Common.Ice;
using ElementalHearts.Content.Items.Hearts.Vanilla.Common.Organic;
using ElementalHearts.Content.Items.Hearts.Vanilla.Common.Sand;
using ElementalHearts.Content.Items.Hearts.Vanilla.Common.Sky;
...
using ElementalHearts.Content.Items.Hearts.Vanilla.Uncommon.Dyes;
using ElementalHearts.Content.Items.Hearts.Vanilla.Uncommon.Gems;
using ElementalHearts.Content.Items.Hearts.Vanilla.Uncommon.Herbs;
