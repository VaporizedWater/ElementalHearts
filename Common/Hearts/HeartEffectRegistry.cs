...
public static class HeartEffectRegistry
{
	...
	private static readonly Dictionary<string, HeartEffect> Effects = new()
	{
		...
		// Outer-ring colour matches each potion's bottle / buff icon.
		["AmmoReservationHeart"]  = Eff(202, 172, 92),
		["ArcheryHeart"]          = Eff(220, 130, 40),
		["BattleHeart"]           = Eff(212, 72, 72),
		["BiomeSightHeart"]       = Eff(232, 122, 232, 122, 232, 152, 232, 192, 92),
		["BuilderHeart"]          = Eff(222, 192, 102),
		["CalmingHeart"]          = Eff(132, 152, 222),
		["CrateHeart"]            = Eff(172, 112, 62),
		["DangersenseHeart"]      = Eff(222, 92, 112),
		["EnduranceHeart"]        = Eff(232, 122, 42),
		["FeatherfallHeart"]      = Eff(232, 192, 220),
		["FishingHeart"]          = Eff(82, 142, 222),
		["FlipperHeart"]          = Eff(102, 182, 212),
		["GillsHeart"]            = Eff(72, 172, 162),
		["GravitationHeart"]      = Eff(152, 72, 192),
		["HeartreachHeart"]       = Eff(232, 102, 142),
		["HunterHeart"]           = Eff(122, 202, 92),
		["InfernoHeart"]          = Eff(232, 92, 42, 252, 162, 52),
		["IronskinHeart"]         = Eff(172, 172, 182),
		["LifeforceHeart"]        = Eff(212, 52, 82),
		["LoveHeart"]             = Eff(252, 122, 192, 252, 192, 222),
		["MagicPowerHeart"]       = Eff(172, 102, 212),
		["ManaRegenerationHeart"] = Eff(102, 142, 222),
		["MiningHeart"]           = Eff(192, 132, 72),
		["NightOwlHeart"]         = Eff(62, 72, 122),
		["ObsidianSkinHeart"]     = Eff(52, 42, 72),
		["RageHeart"]             = Eff(222, 62, 52),
		["RegenerationHeart"]     = Eff(232, 122, 152),
		["ShineHeart"]            = Eff(252, 232, 132),
		["SonarHeart"]            = Eff(242, 212, 92),
		["SpelunkerHeart"]        = Eff(252, 202, 72),
		["StinkHeart"]            = Eff(112, 132, 62, 152, 122, 72),
		["SummoningHeart"]        = Eff(192, 122, 222),
		["SwiftnessHeart"]        = Eff(202, 232, 92),
		["ThornsHeart"]           = Eff(102, 152, 82),
		["TitanHeart"]            = Eff(232, 142, 52),
		["WarmthHeart"]           = Eff(232, 152, 92),
		["WaterWalkingHeart"]     = Eff(82, 162, 232),
		["WrathHeart"]            = Eff(192, 42, 52),
